...
var x=function(e){var t,n,r,i,o,s,a,u,l,c,p,f,h,d,m,g,y,v,b,_="sizzle"+1*new Date,w=e.document,E=0,x=0,O=se(),C=se(),S=se(),T=function(e,t){return e===t&&(p=!0),0},P={}.hasOwnProperty,A=[],R=A.pop,k=A.push,j=A.push,N=A.slice,D=function(e,t){for(var n=0,r=e.length;n<r;n++)if(e[n]===t)return n
...
return e.insertBefore(n.element,i,n.nextSibling),new t(new se(n.element,i),i)},t.prototype.update=function(e,t){return!!Te(t)&&(this.textNode.nodeValue=t,!0)},t}(Pe),je=function(e){function t(){return Oe(this,t),Ee(this,e.apply(this,arguments))}return xe(t,e),t.insert=function(e,n,r){return new t(e.insertHTMLBefore(n.element,n.nextSibling,r))},t.prototype.update=function(e,t){var n,r,i
...
return this.get("hide")||e&&(!t||t<=1)}),pages:Ember.computed("count","current","countOut","countIn",function(){for(var e=this.get("seperator"),t=this.get("current"),n=this.get("count"),r=this.get("countOut"),i=this.get("countIn"),o=[],s=void 0,a=Math.min(r,n),u=Math.max(1,n-r+1),l=n,c=Math.max(a+1,t-i),p=Math.min(u-1,t+i),f=p>=c,h=Math.floor((a+c)/2),d=f&&c-a>1,m=Math.floor((p+u)/2),g=f&&u-p>1,y=[],v=1;v<=a;v++)y[v]=v
for(d&&(y[h]=e),s=c;s<=p;s++)y[s]=s
for(g&&(y[m]=e),s=u;s<=l;s++)y[s]=s
return y.forEach(function(e){o.push(e)}),o}),click:function(e){e.preventDefault()},actions:{next:function(){if(!this.get("disabled")&&!this.get("isLast")){var e=parseInt(this.get("current"),10),t=e+1
